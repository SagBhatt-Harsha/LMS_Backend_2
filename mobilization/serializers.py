...
class MobilizationSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        mobilization_record = MobilizationRecord.objects.create(**validated_data)

        for qualification_data in qualifications_data:
            Qualification.objects.create(record=mobilization_record, **qualification_data)
    ...
    def update(self, instance, validated_data):
        ...
        if qualifications_data is not None:
            ...
            for qualification_data in qualifications_data:
                Qualification.objects.create(record=instance, **qualification_data)
